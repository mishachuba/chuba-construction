...
export function ROContactForm() {
  const { contact } = roLandingConfig;
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: `${contact.subjectPrefix} from ${formData.get("name")}`,
  ...
  return (
    <section
      ...
      aria-labelledby="ro-quote-heading"
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto grid max-w-5xl gap-10 lg:grid-cols-5">
          <div className="space-y-6 lg:col-span-2">
            <div className="rounded-xl border-2 border-cta bg-cta-light p-5">
              <p className="text-sm font-semibold uppercase tracking-wide text-brand-navy">
                East Bay Special
              </p>
              <p className="mt-1 text-3xl font-bold text-cta">
            ...
            <div className="flex items-start gap-3">
              ...
              />
              <div>
                <p className="font-semibold text-brand-navy">Call or text</p>
                <CallTextLink className="text-lg text-warm-700 underline-offset-4 hover:text-brand-navy hover:underline">
            ...
            <div className="flex items-start gap-3">
              ...
              />
              <div>
                <p className="font-semibold text-brand-navy">Based in</p>
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-4">
                <div className="absolute -left-[9999px]" aria-hidden="true">
                  <label htmlFor="ro-botcheck">Leave empty</label>
                  <input
                    type="text"
                    id="ro-botcheck"
                    name="botcheck"
                ...
                <div>
                  ...
                  <input
                    ...
                    aria-describedby={errors.name ? "ro-name-error" : undefined}
                  />
                  {errors.name && (
                    <p id="ro-name-error" className={errorClasses} role="alert">
                      {errors.name}
                    </p>
                  )}
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      aria-describedby={
                        errors.email ? "ro-email-error" : undefined
                      }
                    />
                    {errors.email && (
                      <p id="ro-email-error" className={errorClasses} role="alert">
                        {errors.email}
                      </p>
                    )}
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      aria-describedby={
                        errors.phone ? "ro-phone-error" : undefined
                      }
                    />
                    {errors.phone && (
                      <p id="ro-phone-error" className={errorClasses} role="alert">
                        {errors.phone}
                      </p>
                    )}
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    aria-describedby={errors.zip ? "ro-zip-error" : undefined}
                  />
                  {errors.zip && (
                    <p id="ro-zip-error" className={errorClasses} role="alert">
                      {errors.zip}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    defaultValue={contact.defaultMessage}
                    className={inputClasses}
                    aria-invalid={!!errors.message}
                    aria-describedby={
                      errors.message ? "ro-message-error" : undefined
                    }
                  />
                  {errors.message && (
                    <p id="ro-message-error" className={errorClasses} role="alert">
                      {errors.message}
                    </p>
                  )}
                </div>
